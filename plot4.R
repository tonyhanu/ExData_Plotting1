...
par(mfcol = c(2,2))
plot(d1$daytime, d1$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
...
plot(d1$daytime, d1$Voltage, type = 'l', xlab = "datetime", ylab = "Voltage")

plot(d1$daytime, d1$Global_reactive_power, type = 'l', xlab = "datetime", ylab = "Global_reactive_power")
